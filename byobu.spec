...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1701938794
...
cp %{_builddir}/byobu-%{version}/COPYING %{buildroot}/usr/share/package-licenses/byobu/842745cb706f8f2126506f544492f7a80dbe29b3 || :
%make_install
